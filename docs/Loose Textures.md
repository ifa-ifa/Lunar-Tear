This method of texture replacment requires the sme resolution, format and mipmap count as the original. If you want higher resolution, you should use Custom Archives
